...
| <a name="output_connection_strings_dotnet"></a> [connection\_strings\_dotnet](#output\_connection\_strings\_dotnet) | A mapping of database connection strings for this SQL Server. |
